...
async def ping_handler(c: Client, m: "types.Message"):
    if not m.from_user:
        return await m.reply_text("I don't know about you Pooka :(")
    ...
    await c.send_flooded_message(
        ...
        text="Hi, I am Rename Bot!\n\n"
             ...
             "Just send me media and reply to it with /rename command Created By @MutyalaHarshith.",
...
async def help_handler(c: Client, m: "types.Message"):
    ...
    await c.send_flooded_message(
        ...
        text="I can rename media without downloading it!\n"
             ...
             "To see custom thumbnail press /show_thumbnail Created By @MutyalaHarshith",
        reply_markup=types.InlineKeyboardMarkup([[
           types.InlineKeyboardButton("Show Settings",
                                      callback_data="showSettings")]])
    )
